...
![My-Books-로그인 drawio (4)](https://github.com/masiljangajji/jankens/assets/61807355/64272694-c00d-4987-83f7-db7b18dd3ee0)
...
토큰 
 - 담당자 : 이승재
  - Access Token(30분) , Refresh Token(1시간)
    -  웹 환경에서의 서비스를 기본으로 하고있기 떄문에 Refresh Token 의 시간을 1시간으로 비교적 작게 잡아줌 
